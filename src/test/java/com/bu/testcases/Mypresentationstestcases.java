...
import com.bu.pages.Importingpage;
import com.bu.pages.Launchingpage;
import com.bu.pages.Loadingpage;
import com.bu.pages.Mypresentationspage;
import com.bu.pages.Newpresentation;
import com.bu.utilities.Constatnts;
import com.relevantcodes.extentreports.LogStatus;

public class Mypresentationstestcases extends Basetest{
	@Test
	...
	// to pass the object and driver from test case to page	(this class - another class)
		...
		Mypresentationspage present=home.mypresentations();
		PageFactory.initElements(driver, present);
		Newpresentation newpresntation=present.newPresentation();
		PageFactory.initElements(driver, newpresntation);
		Importingpage imp=newpresntation.create();
		PageFactory.initElements(driver, imp);
		imp.importfromPowerpoint();
